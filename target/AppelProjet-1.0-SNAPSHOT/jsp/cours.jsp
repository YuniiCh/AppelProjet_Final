...
<%
    ...
    if(cours != null) {
        ...
        out.print("<tr><th>Num</th><th>Nom de Cours</th><th>Type de Cours</th><th>Formation</th><th>Consultation des fiches d'appel</th></tr>");
        for (Cours c: cours) {

            out.println("<tr><td>"+ c.getIdCours() +"</td><td>" + c.getNomCours() + "</td>" +
                    "<td>" + c.getTypeCours() + "</td>"+
                    "<td>" + c.getFormation().getNomFormation() + "</td>" +
                    "<td><a href='coursCtrl?idC="+ c.getIdCours() + "'><button>Fiche d'appel</button></a></td></tr>");
        }
        out.print("</table>");
    }
