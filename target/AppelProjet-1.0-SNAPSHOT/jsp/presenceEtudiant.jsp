...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
        <h5><b><i class="fa fa-dashboard"></i> Etat Présence </b></h5>
    </header>
    <!-- Ajouter la nouvel page ici - le contenue dans la balise Body -->
    <div  class="w3-container">
    <table class="table middle">
        <tbody>
        <tr><th>Num</th><th>Type de Cours</th><th>Nom de Cours</th><th>Nombre Présence</th><th>Nombre Retard</th><th>Nombre Absence</th></tr>
        <%
            ...
            List<Cours> cours = (List<Cours>) request.getAttribute("list_cours");
                for (Cours c: cours) {
                    int nbPresence = CoursDAO.nbPresenceCoursEtudiant(c.getIdCours(), utilisateur.getIdU());
                    int nbRetard = CoursDAO.nbRetardCoursEtudiant(c.getIdCours(), utilisateur.getIdU());
                    int nbAbsence = CoursDAO.nbAbsenceCoursEtudiant(c.getIdCours(), utilisateur.getIdU());
                    String style = "#a8e2f8;";
                    if (nbAbsence >= 3 ){ style = "#ffcc99;";}else if (nbRetard>=3){style = "#ffff66;";}
                    out.println("<tr style='background-color:"+ style +"'><td>"+ c.getIdCours() +"</td>" +
